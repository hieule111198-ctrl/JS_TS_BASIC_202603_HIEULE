...
// YC 1
console.log("Bài làm của Hiếu");

let truongTraVe = Object.keys(apiResponse);
console.log(`Số trường trả về = ${truongTraVe.length}`);
...
// YC 3
let isBoolean = typeof(apiResponse.isActive);
if (isBoolean === Boolean) {
  console.log("isActive là kiểu boolean");
} else {
  console.log("isActive ko phải là kiểu boolean");
}
...
console.log("Kết thúc bài của Hiếu");
